...
// * @author pesho
// */
//public class AvoidOppAndBallStrategy implements IStrategy{
//
//    @Override
...
//        System.out.println("Avoid opponent and Ball");
//        int power = 100;
//        Point opp = state.getOpponent().getPose().getPosition();
//        Point self = state.getSelf().getPose().getPosition();
//        Point ball = state.getBall().getPosition();
...
//            if (Distance.euclidean(mta.getTarget(), state.getBall().getPosition()) < 7)
//                return true;
//        }
//        return false;
//    }
